...
class CallAddPage extends StatefulWidget {
  const CallAddPage(this.showAppBar, {super.key});
...
class _CallAddPageState extends State<CallAddPage> {
  ...
  void initState() {
    super.initState();
    // Récupérer le numéro passé en argument si disponible
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final args = ModalRoute.of(context)?.settings.arguments;
      if (args != null && args is String) {
        _numberController.text = args;
      }
    });
  }
        ...
        return ListTile(
            ...
            onTap: () {
              setState(() {
                ...
                _numberController.text = cdr.remoteExt;
                _selCdrRowIdx = index;
              });
            });
      },
  ...
  void _invite(bool withVideo) {
    ...
    CallDestination dest = CallDestination(
        _numberController.text, accounts.selAccountId!, withVideo);
